<%-- 
    ...
    Created on : 09-08-2021, 12:30:38
    Author     : Usuario
--%>
...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/0b96115717.js" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/Controlador?accion=edit&idCliente=${cliente.idCliente}" method="POST" class="was-validated">

            <!--Navbar-->
            <jsp:include page="/WEB-INF/paginas/comunes/navbarEdit.jsp"/>
